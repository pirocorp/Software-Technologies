...
public class Main {
    public static void main(String[] args) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("javablogdb");
    ...
    public static void getSpecificAuthor(EntityManager entityManager, CriteriaBuilder criteriaBuilder, long postId){
        CriteriaQuery<User> query = criteriaBuilder.createQuery(User.class);
        Root<User> userRoot = query.from(User.class);

        query.where(criteriaBuilder.equal(userRoot.join("posts").get("id"), postId));
    ...
    public static void editPost(EntityManager entityManager, int postId){
    ...
    public static void deletePost(EntityManager entityManager, int postId) {
        Post post = entityManager.find(Post.class, postId);
